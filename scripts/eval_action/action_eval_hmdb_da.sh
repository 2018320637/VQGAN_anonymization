#!/bin/bash
cd ../..
CUDA_VISIBLE_DEVICES=4 python eval_action_da.py \
    --src 'hmdb' \
    --num_frames 16 \
    ...
    --self_pretrained_pseudo '/home/zhiwei/source/SPAct/anonymization_training/action_da_logs_vqgan/train_action_da_hmdb2ucf_frames_16_bs_30_lr_0.005_optimizer_sgd_action_1.0_pseudo_1.0_entropy_1.0_domain_1.0/model_hmdb2ucf_48_acc_0.9667250437828371.pth' \
