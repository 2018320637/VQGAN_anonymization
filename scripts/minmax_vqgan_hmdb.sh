#!/bin/bash
cd ..
OMP_NUM_THREADS=4 CUDA_VISIBLE_DEVICES=4,5,6 torchrun --nproc_per_node 3 --master_port 29506 vqgan_minmax.py \
    --src 'hmdb' \
    --tar 'ucf' \
    --num_frames 16 \
    ...
    # --self_pretrained_privacy '/home/zhiwei/source/SPAct/anonymization_training/privacy_logs_vqgan/privacy_vqgan_hmdb_frames_16_every_2_bs_8_lr_0.0_lr_privacy_0.001_codes_16384_dis_iter_50/model_0.6539_0.4413.pth'